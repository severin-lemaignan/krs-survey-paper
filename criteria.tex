...
\begin{itemize}
	...
	point of view on the world. This ability is often referred as the
	\emph{perspective taking} ability.

        \cite{Levesque2008}, p. 4

        \item{\bf Introspection: What can I do?}
		\begin{itemize}
			\item{\bf General introspection}
			The ability for the robot to represent its own capabilities.
			\item{\bf Meta-cognition: knowledge about the knowledge}
		\end{itemize}
    ...
    \begin{itemize}
        ...
        \item{\bf Standard Reasoning Techniques}
		\begin{itemize} 
			
			\item{\bf Inferences and backtracking}
			\item{\bf Classification}			
			\item{\bf Inconsistencies detection}			

		\end{itemize}



        \item{\bf Reasoning with uncertainty}
