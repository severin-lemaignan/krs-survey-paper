...
Some systems \cite{Kunze??} rely on external dedicated physics engine to
...
Memory has been studied at lenght in the cognitive neuroscience community, and
the ability to forget is proven to play a key role for the cognition.
\fxwarning{Add references -> ask Claire or Gladys}.

Most knowledge representation systems offers some kind of working memory as a
pool of facts that are not forgotten by the robot until it is halted. Some
systems may propose persistent storages that allow the robot knowledge to grow
over time, while other may offer a larger range of memory categories, like
short term memory (that last for a couple of seconds) or episodic memory (that
allows the robot to selectively remember facts associated to specific events).
\fxwarning{Add references of paper in the robotics community that have
explicitely tackled the memory issue}.
...
{} & {\sc KnowRob} & {ORO} & {\sc PEIS} & {\sc CAST} & {\sc Golog} & {\sc NKRL} & {\sc GSM} & {\sc OMKRF} & {\sc DY-KNOW} \\


\hline
\showrowcolors
{\bf Expressiveness} & & & & & & & & &  \\
Formal Logic & Prolog & OWL-DL & {\sc CycL} &  &  &  & & & \\
OWA/CWA & CWA & OWA & & & & & & & \\
Modeling uncertainty & +++ (add-on) & & & & & & & & \\
Meta-cognition & ++ & ++ & & & & & & & \\
{\bf Model} & & & & & & & & &  \\
{\bf Reasoning} & & & & & & & & &  \\
Standard FOL reasoning & +++ & +++ & & & & & & &  \\
Lazy evaluation & +++ & & & & & & & &  \\
Reasoning under uncertainty & ++ (add-on) & & & & & & & & \\
Non-monotonic reasoning & & & & & & & & &  \\
Presupposition accomodation & & & & & & & +++ & &  \\
Prediction, projection, diagnosis & & & & & & & & &  \\
Physics-based reasoning & +++ (add-on) & & & & & & & &  \\
Planning & + & +++ (external module) & & & & & & &  \\
Knowledge structure alteration & & ++ & & & & & & &  \\
Learning & & & & & & & & &  \\
{\bf Knowledge Acquisition} & & & & & & & & &  \\
{\bf Integration} & & & & & & & & &  \\
{\bf Knowledge Instanciation} & & & & & & & & &  \\
\hline
