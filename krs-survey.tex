...
upper-ontologies commonly used in the semantic Web community.

\fxwarning{Add metrics for SUMO, OpenCyc, ResearchCyc}
...
\toprule
{\bf Project} & {\bf Expressiveness} & {\bf Axioms} & {\bf Classes} & {\bf Properties} & {\bf Instances} \\
\midrule
OpenCyc \\
ResearchCyc \\
SUMO \\
