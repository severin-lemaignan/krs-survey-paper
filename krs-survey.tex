...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{The Cognitive Scenario}
...
\subsubsection{Introspection: what can I do?}
\label{sect|introspection}

\paragraph{General introspection}

Modelling of the robot capabilities.

\paragraph{Meta-cognition: knowledge on the knowledge}
...
\subsubsection{Prediction and projection and diagnosis tasks}
