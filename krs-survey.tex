...
model three important \emph{roles}\fxwarning{Reference on the term 'role'?}.
...
Logical modality allows to implement alternative mental models. They may be
...
\begin{figure}
        ...
        \subfigure[Sally puts the ball in the beige box.]{
            \includegraphics[scale=0.3]{sally_ann1.pdf}
        } \hspace{8pt} %
        \subfigure[She goes away.]{
            \includegraphics[scale=0.3]{sally_ann2.pdf}
        } \\
        \subfigure[Ann moves the ball.]{
            \includegraphics[scale=0.3]{sally_ann3.pdf}
        } \hspace{8pt} %
        \subfigure[Where will Sally look for the ball?]{
            \includegraphics[scale=0.3]{sally_ann4.pdf}
...
\scriptsize
\begin{enumerate}
    \item \concept{myself} {\bf Type} \concept{belongsTo} {\bf some} \concept{Thing}
    \item \concept{belongsTo} {\bf Domain} \concept{Artifact}
    \item \concept{myself} {\bf Type} \concept{Agent}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\columnwidth]{jakobson_communication_model.pdf}
...
OUR-K & KRS & Suh et al. \par (Hanyang Univ.) & \url{incorl.hanyang.ac.kr/xe} & ? & Horn Clauses & ? & \cite{Suh2007} \\
...
\begin{figure}
    \centering
    \includegraphics[scale=0.36]{knowrob.pdf}
...
language has been experimented with~\cite{Tenorth2009b}.
...
\begin{figure}
    ...
    of \emph{levels}. Figure based on~\ref{Lim2011}.}
...
\toprule
\multicolumn{2}{c}{\bf Category} & {\sc KnowRob} & {ORO} & {\sc PEIS} & {\sc CAST} & {\sc Ke Jia} & {\sc NKRL} & {\sc GSM} & {\sc OUR-K} & {\sc ARMAR} & {\sc Hertzberg} \\
