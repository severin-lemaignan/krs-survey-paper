...
\begin{figure}
    \centering
    \includegraphics[width=0.3\columnwidth]{expressive_overlap_dl_horn.pdf}
...
On the contrary, the directional relation \concept{nextTo} is relative, and
depends on the relative size of the subject and the object. Two houses distant
of 2 meters from each other can be considered as next to each other. Two ants
separated by 2 meters are not next to each other.

The relation \concept{leftOf} is another example of relative spatial relation,
this time because it depends on the observer viewpoint. These relations are
also called \emph{egocentric}.
