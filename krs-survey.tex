...
%\begin{tabularx}{\textheight}{p{2cm}p{4cm}p{3cm}p{4cm}p{2.3cm}p{2cm}p{2cm}}
\begin{tabular}{p{4.5cm}|ccccccccc}
\hiderowcolors

{} & {\sc KnowRob} & {ORO} & {\sc PEIS} & {\sc CAST} & {\sc Golog} & {\sc NKRL} & {\sc GSM} & {\sc OMRKF} & {\sc DY-KNOW} \\


\hline
\showrowcolors
{\bf Expressiveness} & & & & & & & & &  \\
Logical formalism & Prolog & OWL-DL & {\sc CycL} &  &  &  & & Horn clauses & \\
Expressive power & & & & & & & & &  \\
OWA/CWA & CWA & OWA & & & & & & & \\
