...
\tikzstyle {taxonomy} = [grow=right, level distance = 3cm, sibling
distance=7mm]
\tikzstyle {completetaxonomy} = [grow=right]
\tikzstyle {taxon} = [text width=3cm, text centered,inner sep=0pt, outer
sep=2pt] %, draw=blue!50,thick]
...
DFKI Saarbrücken) & & Amodal proxies & \cite{Jacobsson2008} \\
