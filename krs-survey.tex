...
possibly different from one's own.

\begin{figure}
        \centering
        \includegraphics[width=0.9\columnwidth]{sally_ann.pdf}
        \caption{The standard ``Sally and Ann'' false-beliefs experiment, taken from~\cite{Leslie2000}.}
        \label{fig|sally-ann}
\end{figure}

Perceiving and understanding other's \emph{attention} has been identified as
essential to the development of a theory of mind by
Baron-Cohen~\cite{Baron-Cohen1985, Leslie2000}. In
robotics~\cite{Scassellati2002}
